...
////import com.sany.bl.core.support.StrKit;
//
///**
// * 高频方法集合类
// */
...
//
//    /**
//     * 密码正则判断：长度至少8位，包含数字、大写、小写、特殊字符4种中的三种
//     * @param pswd
//     * @return
//     */
//    public  static boolean judgePswd(String pswd){
//        if(StringUtils.isBlank(pswd)) return false;
////        String regex = "^(?=.*[a-z])(?=.*[A-Z])(?=.*\\d)(?=.*[$@$!%*?&])[A-Za-z\\d$@$!%*?&]{8,}";
//        String regex = "^(?![a-zA-Z]+$)(?![A-Z0-9]+$)(?![A-Z\\W_!@#$%^&*`~()-+=]+$)(?![a-z0-9]+$)(?![a-z\\W_!@#$%^&*`~()-+=]+$)(?![0-9\\W_!@#$%^&*`~()-+=]+$)[a-zA-Z0-9\\W_!@#$%^&*`~()-+=]{8,30}$";
//        return match(regex, pswd);
//    }
//
//    public  static boolean judgePswdSimple(String pswd){
//        if(StringUtils.isBlank(pswd)) return false;
//        if(pswd.length()<6){
//            return false;
//        }
...
//     * @return
//     */
//    public static List<String> getPast7Date(){
//        List<String> result= Lists.newArrayList();
//        for(int i=0;i<=6;i++){
//            result.add(getPastDate(i));
//        }
//        return  result;
//    }
//
...
//     * @return
//     */
//    public static List<String> getPast12Month(){
//        List<String> result= Lists.newArrayList();
//
//        Calendar cal=Calendar.getInstance();
//        cal.set(Calendar.MONTH,cal.get(Calendar.MONTH)+1);//加1才能把本月算进去
//        for(int i=11;i>=0;i--){
//            cal.set(Calendar.MONTH,cal.get(Calendar.MONTH)-1);//逐次往前推1个月
//            result.add(cal.get(Calendar.YEAR)+"-"+String.format("%02d",(cal.get(Calendar.MONTH)+1)));
//        }
//
...
//
//
//    public static <T> List<Map<String, Object>> objectsToMapList(List<T> objList) {
...
//     * @param result 目标图片路径
//     */
//    public static void convertImg(String source, String formatName, String result) {
//        try {
...
//                 Thumbnails.of(result).scale(0.5f).outputQuality(0.2f).toFile(result);
//            }
//        } catch (Exception e) {
//            e.printStackTrace();
//        }
